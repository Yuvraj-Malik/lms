      ...
      <Card className="w-full">
        ...
        <form onSubmit={handleSubmit} className="mt-6 space-y-4">
          ...
          <div className="flex justify-end">
            <Link to="/forgot-password" className="text-xs font-medium text-pine dark:text-amber-light">
              Forgot password?
            </Link>
          </div>
        ...
        <p className="mt-6 text-center text-sm text-ink-soft dark:text-dark-ink-soft">
          ...
          <Link to="/register" className="font-medium text-pine dark:text-amber-light">
            Sign up
          </Link>
        </p>
        <p className="mt-3 rounded-lg bg-surface-sunken px-3 py-2 text-center text-xs text-ink-soft dark:bg-dark-surface-sunken dark:text-dark-ink-soft">
          Demo: admin@lms.com / admin123 · student@lms.com / student123
        </p>
      </Card>
    </div>
  );
